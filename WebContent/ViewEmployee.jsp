        ...
        <div class="navbar-collapse">
            <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
                <ul class="nav" id="side-menu">
						<li>
							<a href="Admin.html"><i class="fa fa-check-square-o nav_icon"></i>Admin</a>
						</li>
						<li>
							<a href="AddEmployee.html"><i class="fa fa-table nav_icon"></i>Add NewEmployee</a>
						</li>
						<li>
							<a href="ViewEmployee.jsp"><i class="fa fa-cogs nav_icon"></i>View All Employee</a>
						</li>
						<li>
                ...
                <ul>
                    <li class="dropdown profile_details_drop">
                        ...
                        <ul class="dropdown-menu drp-mnu">
                            <li> <a href="Admin.html"><i class="fa fa-sign-out"></i> Logout</a> </li>
                        </ul>
                    </li>
                </ul>
            </div>
